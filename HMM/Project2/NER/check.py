...
if __name__ == "__main__":
    #check(language = "Chinese", gold_path="HMM/Project2/NER/Chinese/validation.txt", my_path="HMM/my_pred_Chinese.txt")
    check(language = "Chinese", gold_path="HMM/Project2/NER/English/validation.txt", my_path="HMM/my_pred_English.txt")